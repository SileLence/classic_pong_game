...
public enum TextKey {
    ...
    EXIT("Выход", "Exit"),
    POINTS_TO_WIN("Очки до победы:", "Points to Win:"),
    THREE("3", "3"),
    FIVE("5", "5"),
    SEVEN("7", "7"),
    TEN("10", "10"),
    FIFTEEN("15", "15"),
    TWENTY_ONE("21", "21"),
    BALL_SPEED("Скорость мяча:", "Ball Speed:"),
    ...
    STARTING_SERVE("Первая подача:", "Starting Serve:"),
    ...
    RU("Русский", "Русский"),
    EN("English", "English"),
    RESET_BEST("Сбросить рекорд", "Reset Best Score"),
